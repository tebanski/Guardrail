...
class Vector3d(object):
    ...
    def _calvector(self):
        ...
        '''
        return list(
            map(lambda val, offset: val - offset, self._vector, self.cal))

    @property
    def x(self):
        # Corrected, vehicle relative floating point values
        self.update()
    ...
    @property
    def magnitude(self):
        # All measurements must correspond to the same instant
        x, y, z = self.xyz
